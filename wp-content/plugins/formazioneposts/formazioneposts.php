  ...
  $fp_output .= '
		<div class="dc-ff-football-formation" style="'.$style_field.'">
			<div class="dc-ff-player" style="'.$style1.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl1_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl1_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style2.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl2_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl2_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style3.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl3_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl3_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style4.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl4_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl4_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style5.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl5_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl5_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style6.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl6_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl6_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style7.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl7_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl7_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style8.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl8_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl8_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style9.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl9_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl9_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style10.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl10_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl10_name"].'</div>
			</div>
			<div class="dc-ff-player" style="'.$style11.'">
				<div class="dc-ff-player-number">'.$incomingfromhandler["pl11_num"].'</div>
				<div class="dc-ff-player-name">'.$incomingfromhandler["pl11_name"].'</div>
			</div>
		</div>
  ';
