...
//short name per widget in spalla
if ($widget){
  $shortName='';
  switch ($team->title){
    case 'Pozzo':
    ...
    case 'San Giovanni Lupatoto':
      $shortName = 'S. Giov. L.';
      break;
    case 'Juventina Valpantena':
      $shortName = 'Juventina P.';
      break;
    case 'Calcio Caldiero Terme':
      $shortName = 'Caldiero T.';
      break;
    case 'Sampietrina':
      $shortName = 'Sampietrina';
      break;
    case 'S. Martino Speme':
      $shortName = 'Speme';
      break;
    case 'Montorio Calcio':
      $shortName = 'Montorio';
      break;
    case 'Provese':
      $shortName = 'Provese';
      break;
    case 'Quinto Valpantena':      
      $shortName = 'Quinto V.';
      break;
    default:
  }
  $teams[$i]->title=$shortName;
}
