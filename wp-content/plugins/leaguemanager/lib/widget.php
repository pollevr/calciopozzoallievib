...
class LeagueManagerWidget extends WP_Widget
{
	...
	function showNextMatchBox($number, $instance, $echo = true)
	{
		...
		if ( $matches ) {
			...
			$out .= "<p class='logos'><img class='home_logo' src='".$teams[$match->home_team]['logo']."' alt='".$teams[$match->home_team]['title']."' width='50' /><img class='away_logo' src='".$teams[$match->away_team]['logo']."' alt='".$teams[$match->away_team]['title']."' width='50' /></p>";
	...
	function showPrevMatchBox($number, $instance, $echo = true)
	{
		...
		if ( $matches ) {
			...
			$out .= "<p class='match_title'><strong>". $match->title."</strong></p>";
			$out .= "<p class='logos'><img class='home_logo' src='".$teams[$match->home_team]['logo']."' alt='".$teams[$match->home_team]['title']."' width='50' /><span class='result'>".$score."</span><img class='away_logo' src='".$teams[$match->away_team]['logo']."' alt='".$teams[$match->away_team]['title']."' width='50' /></p>";
