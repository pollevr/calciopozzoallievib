	...
	*/
	...
	function getTableHeader( $args = array() )
	{
		...
		if ( $form_fields = $this->getFormFields() ) {
          ...
          $form_field->type == 'formazione' ? $footableHideMobileClass = "data-hide='phone,tablet'" : $footableHideMobileClass = "";
					if ( 1 == $form_field->show_on_startpage)
					  $out .= "\n\t<th scope='col' class='tableheader ".$form_field->type."' ".$footableHideMobileClass.">".stripslashes($form_field->label)."</th>";
				}
			}
		}
		return $out;
